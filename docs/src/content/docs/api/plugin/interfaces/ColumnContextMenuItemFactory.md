...
[`ColumnContextMenuItemContext`](/seizen-ui/api/plugin/interfaces/columncontextmenuitemcontext/)\<`TData`, `TArgs`\>

#### Returns

[`ContextMenuItemEntry`](/seizen-ui/api/plugin/interfaces/contextmenuitementry/)
